...
.slds-card {
  position: relative;
  padding-top: var(--slds-c-card-spacing-blockstart, var(--slds-c-card-spacing-block-start,var(--slds-c-card-spacing-block,var(--sds-c-card-spacing-block-start, var(--sds-c-card-spacing-block, 0)))));
  padding-right: var(--slds-c-card-spacing-inlineend, var(--slds-c-card-spacing-inline-end,var(--slds-c-card-spacing-inline, var(--sds-c-card-spacing-inline-end, var(--sds-c-card-spacing-inline, 0)))));
  padding-bottom: var(--slds-c-card-spacing-blockend, var(--slds-c-card-spacing-block-end,var(--slds-c-card-spacing-block ,var(--sds-c-card-spacing-block-end, var(--sds-c-card-spacing-block, 0)))));
  padding-left: var(--slds-c-card-spacing-inlinestart, var(--slds-c-card-spacing-inline-start,var(--slds-c-card-spacing-inline, var(--sds-c-card-spacing-inline-start, var(--sds-c-card-spacing-inline, 0)))));
...
.slds-card__body--inner {
  ...
  --slds-c-card-body-spacing-inlineend: var(--slds-c-card-body-spacing-inline-end, var(--sds-c-card-body-spacing-inline-end, var(--sds-c-card-body-spacing-inline, #{$var-spacing-horizontal-medium})));

  /*! @css-var-fallback padding-left */
  --slds-c-card-body-spacing-inlinestart: var(--slds-c-card-body-spacing-inline-start, var(--sds-c-card-body-spacing-inline-start, var(--sds-c-card-body-spacing-inline, #{$var-spacing-horizontal-medium})));
  padding-top: 0;
  padding-bottom: 0;
}
...
.slds-card__footer {
  ...
  padding-left:
    ...
    var(--slds-c-card-footer-spacing-inline,
    var(--sds-c-card-footer-spacing-inline, $var-spacing-horizontal-medium)))));
  margin-top: var(--slds-c-card-footer-spacing-blockstart, var(--slds-c-card-footer-spacing-block-start, var(--sds-c-card-footer-spacing-block-start, $var-spacing-vertical-small)));
