...
.slds-notify_alert {
  ...
  width: 100%;
  padding-top: var(
    --slds-c-alert-spacing-blockstart,
    var(--slds-c-alert-spacing-block-start, var(--sds-c-alert-spacing-block-start, 0.5rem))
  );
  padding-right: var(
    --slds-c-alert-spacing-inlineend,
    var(--slds-c-alert-spacing-inline-end, var(--sds-c-alert-spacing-inline-end, 2rem))
  );
  padding-bottom: var(
    --slds-c-alert-spacing-blockend,
    var(--slds-c-alert-spacing-block-end, var(--sds-c-alert-spacing-block-end, 0.5rem))
  );
  padding-left: var(
    --slds-c-alert-spacing-inlinestart,
    var(--slds-c-alert-spacing-inline-start, var(--sds-c-alert-spacing-inline-start, 0.5rem))
  );
