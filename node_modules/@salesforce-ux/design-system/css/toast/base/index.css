...
.slds-notify_toast {
  ...
  margin: 0.5rem;
  padding-top: var(
    --slds-c-toast-spacing-blockstart,
    var(--slds-c-toast-spacing-block-start, var(--sds-c-toast-spacing-block-start, 0.75rem))
  );
  padding-right: var(
    --slds-c-toast-spacing-inlineend,
    var(--slds-c-toast-spacing-inline-end, var(--sds-c-toast-spacing-inline-end, 3rem))
  );
  padding-bottom: var(
    --slds-c-toast-spacing-blockend,
    var(--slds-c-toast-spacing-block-end, var(--sds-c-toast-spacing-block-end, 0.75rem))
  );
  padding-left: var(
    --slds-c-toast-spacing-inlinestart,
    var(--slds-c-toast-spacing-inline-start, var(--sds-c-toast-spacing-inline-start, 1.5rem))
  );
  min-width: var(
    --slds-c-toast-sizing-width-min,
    var(--slds-c-toast-sizing-min-width, var(--sds-c-toast-sizing-min-width, 30rem))
  );
  text-align: left;
