...
.slds-card__footer {
  ...
  margin-top: var(
    --slds-c-card-footer-spacing-blockstart,
    var(--slds-c-card-footer-spacing-block-start, var(--sds-c-card-footer-spacing-block-start, 0.75rem))
  );
