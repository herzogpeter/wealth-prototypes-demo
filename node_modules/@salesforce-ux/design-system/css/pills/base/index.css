...
.slds-pill {
  ...
  padding-top: var(
    ...
    var(--slds-c-pill-spacing-block-start, var(--sds-c-pill-spacing-block-start, 0))
  );
  padding-right: var(
    --slds-c-pill-spacing-inlineend,
    var(--slds-c-pill-spacing-inline-end, var(--sds-c-pill-spacing-inline-end, 0))
  );
  padding-bottom: var(
    --slds-c-pill-spacing-blockend,
    var(--slds-c-pill-spacing-block-end, var(--sds-c-pill-spacing-block-end, 0))
  );
  padding-left: var(
    --slds-c-pill-spacing-inlinestart,
    var(--slds-c-pill-spacing-inline-start, var(--sds-c-pill-spacing-inline-start, 0.125rem))
  );
...
.slds-pill_container {
  ...
  padding-top: var(
    ...
    var(--slds-c-pill-container-spacing-block-start, var(--sds-c-pill-container-spacing-block-start, 0.125rem))
  );
  padding-right: var(
    --slds-c-pill-container-spacing-inlineend,
    var(--slds-c-pill-container-spacing-inline-end, var(--sds-c-pill-container-spacing-inline-end, 0.125rem))
  );
  padding-bottom: var(
    --slds-c-pill-container-spacing-blockend,
    var(--slds-c-pill-container-spacing-block-end, var(--sds-c-pill-container-spacing-block-end, 0.125rem))
  );
  padding-left: var(
    --slds-c-pill-container-spacing-inlinestart,
    var(--slds-c-pill-container-spacing-inline-start, var(--sds-c-pill-container-spacing-inline-start, 0.125rem))
  );
  border-width: var(--slds-c-pill-sizing-border, var(--sds-c-pill-sizing-border, 1px));
  border-style: solid;
  border-color: var(
...
.slds-pill__action {
  ...
  padding-top: var(
    --slds-c-pill-spacing-blockstart,
    var(--slds-c-pill-spacing-block-start, var(--sds-c-pill-spacing-block-start, 0.125rem))
  );
  padding-bottom: var(
    --slds-c-pill-spacing-blockend,
    var(--slds-c-pill-spacing-block-end, var(--sds-c-pill-spacing-block-end, 0.125rem))
  );
  padding-left: var(
    --slds-c-pill-spacing-inlinestart,
    var(--slds-c-pill-spacing-inline-start, var(--sds-c-pill-spacing-inline-start, 0.125rem))
...
.slds-has-error .slds-pill__label {
  ...
  color: var(
    ...
    var(--slds-c-pill-error-text-color, var(--sds-c-pill-error-text-color, var(--slds-g-color-error-base-40, #ea001e)))
  );
}
.slds-has-error:hover {
  --slds-c-pill-text-color-error: var(--slds-g-color-error-base-30, #ea001e);
}
