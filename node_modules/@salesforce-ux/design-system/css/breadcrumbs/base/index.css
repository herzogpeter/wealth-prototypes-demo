...
.slds-breadcrumb .slds-breadcrumb__item > a {
  ...
  padding-top: 0;
  padding-right: var(
    --slds-c-breadcrumbs-spacing-inlineend,
    var(--slds-c-breadcrumbs-spacing-inline-end, var(--sds-c-breadcrumbs-spacing-inline-end, 0.5rem))
  );
  padding-bottom: 0;
  padding-left: var(
    --slds-c-breadcrumbs-spacing-inlinestart,
    var(--slds-c-breadcrumbs-spacing-inline-start, var(--sds-c-breadcrumbs-spacing-inline-start, 0.5rem))
  );
}
