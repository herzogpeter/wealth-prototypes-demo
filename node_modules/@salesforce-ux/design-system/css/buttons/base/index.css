/*! Lightning Design System 2.27.1 */
:root {
...
.slds-button {
  ...
  padding-top: var(
    ...
    var(--slds-c-button-spacing-block-start, var(--sds-c-button-spacing-block-start, 0))
  );
  padding-right: var(
    --slds-c-button-spacing-inlineend,
    var(--slds-c-button-spacing-inline-end, var(--sds-c-button-spacing-inline-end, 0))
  );
  padding-bottom: var(
    --slds-c-button-spacing-blockend,
    var(--slds-c-button-spacing-block-end, var(--sds-c-button-spacing-block-end, 0))
  );
  padding-left: var(
    --slds-c-button-spacing-inlinestart,
    var(--slds-c-button-spacing-inline-start, var(--sds-c-button-spacing-inline-start, 0))
  );
  background: none;
...
a.slds-button--inverse:focus {
  ...
  --slds-c-button-shadow: var(
    ...
    var(--slds-c-button-inverse-shadow-focus, var(--sds-c-button-inverse-shadow-focus, 0 0 3px #f3f3f3))
  );
  outline: none;
}
.slds-button_reset {
...
.slds-button_neutral {
  ...
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-neutral-spacing-inlinestart,
  ...
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-neutral-spacing-inlineend,
...
.slds-button_brand {
  /*! @css-var-fallback padding-left */
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-brand-spacing-inlinestart,
    var(--slds-c-button-brand-spacing-inline-start, var(--sds-c-button-brand-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-brand-spacing-inlineend,
    var(--slds-c-button-brand-spacing-inline-end, var(--sds-c-button-brand-spacing-inline-end, 1rem))
  );
  text-align: center;
  -webkit-box-pack: center;
  -ms-flex-pack: center;
...
.slds-button_outline-brand {
  /*! @css-var-fallback padding-left */
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-outline-brand-spacing-inlinestart,
    var(
  ...
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-outline-brand-spacing-inlineend,
    var(--slds-c-button-outline-brand-spacing-inline-end, var(--sds-c-button-outline-brand-spacing-inline-end, 1rem))
  );
  text-align: center;
  -webkit-box-pack: center;
  -ms-flex-pack: center;
...
.slds-button_inverse {
  /*! @css-var-fallback padding-left */
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-inverse-spacing-inlinestart,
    var(--slds-c-button-inverse-spacing-inline-start, var(--sds-c-button-inverse-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-inverse-spacing-inlineend,
    var(--slds-c-button-inverse-spacing-inline-end, var(--sds-c-button-inverse-spacing-inline-end, 1rem))
  );
  text-align: center;
  -webkit-box-pack: center;
  -ms-flex-pack: center;
...
.slds-button_destructive {
  /*! @css-var-fallback padding-left */
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-destructive-spacing-inlinestart,
    var(--slds-c-button-destructive-spacing-inline-start, var(--sds-c-button-destructive-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-destructive-spacing-inlineend,
    var(--slds-c-button-destructive-spacing-inline-end, var(--sds-c-button-destructive-spacing-inline-end, 1rem))
  );
  text-align: center;
  -webkit-box-pack: center;
  -ms-flex-pack: center;
...
.slds-button_success {
  /*! @css-var-fallback padding-left */
  --slds-c-button-spacing-inlinestart: var(
    --slds-c-button-success-spacing-inlinestart,
    var(--slds-c-button-success-spacing-inline-start, var(--sds-c-button-success-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inlineend: var(
    --slds-c-button-success-spacing-inlineend,
    var(--slds-c-button-success-spacing-inline-end, var(--sds-c-button-success-spacing-inline-end, 1rem))
  );
  text-align: center;
  -webkit-box-pack: center;
  -ms-flex-pack: center;
