...
[kx-scope="button"][kx-type="underline"]:after {
  ...
  height: 0.0625rem;
  width: calc(
    100% - var(--slds-c-button-spacing-inlinestart, var(--slds-c-button-spacing-inline-start, 0rem)) -
      var(--slds-c-button-spacing-inlineend, var(--slds-c-button-spacing-inline-end, 0rem))
  );
