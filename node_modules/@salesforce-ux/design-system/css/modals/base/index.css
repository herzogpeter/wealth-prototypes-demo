...
.slds-modal__header {
  ...
  flex-shrink: 0;
  padding-top: var(
    --slds-c-modal-header-spacing-blockstart,
    var(--slds-c-modal-header-spacing-block-start, var(--sds-c-modal-header-spacing-block-start, 1rem))
  );
  padding-right: var(
    --slds-c-modal-header-spacing-inlineend,
    var(--slds-c-modal-header-spacing-inline-end, var(--sds-c-modal-header-spacing-inline-end, 1rem))
  );
  padding-bottom: var(
    --slds-c-modal-header-spacing-blockend,
    var(--slds-c-modal-header-spacing-block-end, var(--sds-c-modal-header-spacing-block-end, 1rem))
  );
  padding-left: var(
    --slds-c-modal-header-spacing-inlinestart,
    var(--slds-c-modal-header-spacing-inline-start, var(--sds-c-modal-header-spacing-inline-start, 1rem))
  );
  text-align: center;
}
...
.slds-modal__footer {
  ...
  flex-shrink: 0;
  padding-top: var(
    --slds-c-modal-footer-spacing-blockstart,
    var(--slds-c-modal-footer-spacing-block-start, var(--sds-c-modal-footer-spacing-block-start, 0.75rem))
  );
  padding-right: var(
    --slds-c-modal-footer-spacing-inlineend,
    var(--slds-c-modal-footer-spacing-inline-end, var(--sds-c-modal-footer-spacing-inline-end, 1rem))
  );
  padding-bottom: var(
    --slds-c-modal-footer-spacing-blockend,
    var(--slds-c-modal-footer-spacing-block-end, var(--sds-c-modal-footer-spacing-block-end, 0.75rem))
  );
  padding-left: var(
    --slds-c-modal-footer-spacing-inlinestart,
    var(--slds-c-modal-footer-spacing-inline-start, var(--sds-c-modal-footer-spacing-inline-start, 1rem))
  );
  text-align: right;
  -webkit-box-shadow: var(--slds-c-modal-shadow, var(--sds-c-modal-shadow, 0 2px 3px 0 rgba(0, 0, 0, 0.16)));
  box-shadow: var(--slds-c-modal-shadow, var(--sds-c-modal-shadow, 0 2px 3px 0 rgba(0, 0, 0, 0.16)));
