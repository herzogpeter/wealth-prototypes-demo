...
.slds-accordion__summary {
  ...
  padding-right: var(
    --slds-c-accordion-section-spacing-inlineend,
    var(--slds-c-accordion-section-spacing-inline-end, var(--sds-c-accordion-section-spacing-inline-end, 0.75rem))
  );
  padding-bottom: var(
    --slds-c-accordion-section-spacing-blockend,
    var(--slds-c-accordion-section-spacing-block-end, var(--sds-c-accordion-section-spacing-block-end, 0.75rem))
  );
  padding-left: var(
    --slds-c-accordion-section-spacing-inlinestart,
...
.slds-accordion__summary-heading {
  ...
  line-height: var(
    ...
    var(--slds-c-accordion-heading-line-height, var(--sds-c-accordion-heading-line-height, 1.25))
  );
}
