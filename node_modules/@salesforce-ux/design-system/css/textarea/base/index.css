...
.slds-textarea {
  ...
  min-height: var(
    --slds-c-textarea-sizing-height-min,
    var(--slds-c-textarea-sizing-min-height, var(--sds-c-textarea-sizing-min-height))
  );
  width: 100%;
  padding-top: var(
    --slds-c-textarea-spacing-blockstart,
    var(--slds-c-textarea-spacing-block-start, var(--sds-c-textarea-spacing-block-start, 0.5rem))
  );
  padding-right: var(
    --slds-c-textarea-spacing-inlineend,
    var(--slds-c-textarea-spacing-inline-end, var(--sds-c-textarea-spacing-inline-end, 0.75rem))
  );
  padding-bottom: var(
    --slds-c-textarea-spacing-blockend,
    var(--slds-c-textarea-spacing-block-end, var(--sds-c-textarea-spacing-block-end, 0.5rem))
  );
  padding-left: var(
    --slds-c-textarea-spacing-inlinestart,
    var(--slds-c-textarea-spacing-inline-start, var(--sds-c-textarea-spacing-inline-start, 0.75rem))
  );
